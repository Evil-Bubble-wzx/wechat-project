...
;(async()=>{
 ...
 await page.goto('http://127.0.0.1:4173');await page.waitForSelector('.home-book');await page.screenshot({path:'artifacts/production/home-desktop.png',fullPage:true})
